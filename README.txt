...
{10, 10} will then be centered at {30, 30}.
...
comprise the rectangle with -[getLineSegments].
...
You can access the line segments that
comprise the triangle with -[getLineSegments].
...
### Note about Ellipses
Collision detection for ellipses are not quite
perfect.
